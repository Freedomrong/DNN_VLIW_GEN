...
std::string VLIW_1024bit(int count, int m, int n, int k, int conv_num)
{
	...
	int filters_size[14] = { 1, 3, 3, 3,    3, 3, 3, 1,            3, 1, 1,          3,   1, 0 };
	int original[14] = { 1, 16, 32, 64,    128, 256, 512, 1024,    256, 512, 256,    384, 256, 0 };
	//                   C0  C1  C2  C3  C4   C5   C6   C7    C8   C9  C10 C11a C11b C12
	int kstorge[14] =  { 768, 384, 192, 96,   48, 24, 24, 24,   24, 24, 24,    48, 48, 0 };
	int result_back[14] = { 384, 192, 96, 48,  24, 24, 24, 24,  24, 24, 48,   48, 48, 0 };
	...
	else if (conv_num == 4)
	{
		...
		if (count == 1) {
			...
			GlobalBuffer_DDR_enable = 1;
			// GlobalBuffer_DDR_source_address = 0xa7090000 + (long long)(count - 33) * 48 * 48 * 64;
			GlobalBuffer_DDR_source_address = compute_result_first + (long long)(count - 33) * 48 * 48 * 64; //3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
	...
	else if (conv_num == 5)  // layer 5， 输入24x24x256， 存储： 24x24x8 深度
	{
	...
	else if (conv_num == 11)
	{
		if (count % 12 == 1) {
			...
			GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 48 * 48 * 4;  
		}
		else if (count % 12 == 5) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64 * 4;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 48 * 48 * 4;
		}
		else if (count % 12 == 9) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64 * 4 * 2;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 48 * 48 * 4;
		}
		else {
	...
	else if (conv_num == 12)
	{
		...
		// else if (count % 8 == 2) {
		// 	GlobalBuffer_DDR_enable = 1;
		// 	GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64;							//3x3的卷积核必须一次读入
		// 	GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
		// 	GlobalBuffer_DDR_length = 48 * 48;  
		// }
		// else if (count % 8 == 3) {
		// 	GlobalBuffer_DDR_enable = 1;
		// 	GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64 * 2;							//3x3的卷积核必须一次读入
		// 	GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
		// 	GlobalBuffer_DDR_length = 48 * 48;  
		// }
		// else if (count % 8 == 4) {
		// 	GlobalBuffer_DDR_enable = 1;
		// 	GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64 * 3;							//3x3的卷积核必须一次读入
		// 	GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
		// 	GlobalBuffer_DDR_length = 48 * 48;  
		// }
		// else if (count % 8 == 5) {
		...
		// else if (count % 8 == 6) {
		// 	GlobalBuffer_DDR_enable = 1;
		// 	GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64 * 5;							//3x3的卷积核必须一次读入
		// 	GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
		// 	GlobalBuffer_DDR_length = 48 * 48;
		// }
		// else if (count % 8 == 7) {
		// 	GlobalBuffer_DDR_enable = 1;
		// 	GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64 * 6;							//3x3的卷积核必须一次读入
		// 	GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
		// 	GlobalBuffer_DDR_length = 48 * 48;
		// }
		// else if (count % 8 == 0) {
		// 	GlobalBuffer_DDR_enable = 1;
		// 	GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64 * 7;							//3x3的卷积核必须一次读入
		// 	GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
		// 	GlobalBuffer_DDR_length = 48 * 48;
		// }
		// else {
		...
		if (count == 1) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first;
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;  
		}
		else if (count == 2) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 48 * 48 * 64;							//3x3的卷积核必须一次读入
			...
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = DDR_Globalbuffer_first + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
		else if (count == 10) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = (DDR_Globalbuffer_first + 48 * 48 * 64) + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
		else if (count == 11) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address =  (DDR_Globalbuffer_first + 48 * 48 * 64 * 2) + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
		else if (count == 12) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = (DDR_Globalbuffer_first + 48 * 48 * 64 * 3) + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
		else if (count == 13) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = (DDR_Globalbuffer_first + 48 * 48 * 64 * 4) + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
		else if (count == 14) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = (DDR_Globalbuffer_first + 48 * 48 * 64 * 5) + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
		else if (count == 15) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = (DDR_Globalbuffer_first + 48 * 48 * 64 * 6) + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
		else if (count == 16) {
			GlobalBuffer_DDR_enable = 1;
			GlobalBuffer_DDR_source_address = (DDR_Globalbuffer_first + 48 * 48 * 64 * 7) + 24 * 48 * 64;							//3x3的卷积核必须一次读入
			GlobalBuffer_DDR_aim_address = GlobalBuffer_first;
			GlobalBuffer_DDR_length = 24 * 48;
		}
	...
	else if (conv_num == 5 || conv_num == 8 || conv_num == 10)
	{
		...
		if (count % 12 == 1 || count % 12 == 5 || count % 12 == 9) {
			GlobalBuffer_WaitMMU = 1;
		}
		else {
			GlobalBuffer_WaitMMU = 0; // 输入图像在SRAM中，直接算下一条
	...
	else if (conv_num == 5)
	{
		...
		if (count >= 1 && count <= 128) { // 8个为一组
			...
			WeightCache_DDR_enable = 1;
			WeightCache_DDR_source_address = DDR_WeightCacheBuffer_first
				+ block_stride * ((count - 1) % 8)
				+ group_stride * ((count - 1) / 8);
			WeightCache_DDR_aim_address = WeightCache_first;
			WeightCache_DDR_length = 288; // 3*3*128*2
		}
		else {
	...
	else if (conv_num == 12) // conv1x1卷积核, n=8
	{
		if (count >= 1 && count <= m*n)  
		{
			const long long base_stride = 1 * 1 * 64;
		...
		else if (count > m*n)
		{
			...
			WeightCache_DDR_enable = 1;
			WeightCache_DDR_source_address = DDR_WeightCacheBuffer_first
				+ block_stride * (((count-8) - 1) % m) // m = 32
				+ group_stride * (((count-8) - 1) / m);
			WeightCache_DDR_aim_address = WeightCache_first;
			WeightCache_DDR_length = 32; 
		}
		else
	...
	else if (conv_num == 11 || conv_num == 12)
	{
		if (count % m == 1) { Psum_enable = 0; } //当 count 为 1, 9, 17... 时，说明正在计算每一个输出组的第一个输入块。新输入，不累加
		else { Psum_enable = 1; }
	}
	...
	else if  (conv_num == 11)
	{
		if (count % 12 == 0) {
			Bias_enable = 1;
			Bias_source_address = Bias_addr_first + (count / 12 - 1);
		}
		else {
			Bias_enable = 0;
			Bias_source_address = 0;
	...
	else if (conv_num == 5)
	{
		...
		if (count == 8) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first; // 写回ddr，片上不够存
			Compute_Result_length = 24*24; // 24*24result
		}
		else if (count == 16) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 24) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*2; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 32) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*3; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 40) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*4; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 48) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*5; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 56) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*6; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 64) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*7; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 72) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*8; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 80) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*9; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 88) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*10; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 96) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*11; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 104) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*12; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 112) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*13; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 120) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*14; 
			Compute_Result_length = 24*24; // 24*24
		}
		else if (count == 128) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 24 * 64*15; 
			Compute_Result_length = 24*24; // 24*24
		}
		else
		{
	...
	else if (conv_num == 12)
	{
		...
		if (count == 8){
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first; 
			Compute_Result_length = 24*48; // 24*48
		}
		else if (count == 16) {
			Compute_Result_enable = 1;
			Compute_Result_source_address = compute_result_first + 24 * 48 * 64; 
			Compute_Result_length = 24*48; // 24*48
		}
		else {
			Compute_Result_enable = 0;
	...
	else if (conv_num == 5)
	{
		...
		{
			Global_CMD_pooling = 1;
			Global_CMD_pooling_length = 0; // strode = 1
		}
		else
		{
			Global_CMD_pooling = 0;
	...
	else if (conv_num == 5 || conv_num == 6 || conv_num == 8 || conv_num == 11)
	{
		Global_CMD_pad = 1;
		Global_CMD_pad_type = 15;
	}
	else if (conv_num == 7 || conv_num == 9 || conv_num == 10 || conv_num == 12)
	{
		Global_CMD_pad = 0;
		Global_CMD_pad_type = 0;
	}
	...
	{
		fl = fl_data;
		fl_length = fl_length_data; // 因为两个刚好都是0，所以直接复用了。
	}
	else
	{
		fl = fl_data;
