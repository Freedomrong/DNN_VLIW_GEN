...
int original[14] = { 32, 32, 32, 64,     128, 256, 512, 1024,  256, 512, 256,  384, 256, 0 };
//                   C0  C1  C2  C3  C4   C5   C6   C7    C8   C9  C10 C11a C11b C12
int filters[14] = { 32, 32, 64, 128,     256, 512, 1024, 256,  512, 32, 128,   256, 32, 0 };
int filters_size[14] = { 1, 3, 3, 3,   3, 3, 3, 1,   3, 1, 1,      3, 1, 0 };
// fl: 是否需要移位 (fl_length>0则为1)
int fl[14] =           { 0, 1, 1, 1,    1, 0, 1, 1,   0, 0, 0,     0, 0, 0 };
// fl_length: 当前层数据1 - 前一层数据3
int fl_length[14] =    { 0, 1, 2, 2,    1, 0, 1, 1,   0, 0, 0,     0, 0, 0 };
